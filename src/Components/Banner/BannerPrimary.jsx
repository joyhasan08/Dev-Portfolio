...
const BannerPrimary = () => {
    return (
        <div
            ...
            className=' min-h-svh  flex flex-col  items-center text-left space-y-8 px-8 '>

            <div className='flex  text-left space-y-8 items-center justify-between gap-8 max-w-6xl'>
